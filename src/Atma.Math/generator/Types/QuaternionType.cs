    ...
    class QuaternionType : AbstractType
    {
        ...
        public override IEnumerable<Member> GenerateMembers()
        {
            ...
            if (BaseType.IsFloatingPoint)
            {
                ...
                //     Code = new[]
                //     {
                //         $"let localW = {vec3Type.NameThat}.Cross(u, v);",
                //         $"let dot = {vec3Type.NameThat}.Dot(u, v);",
                //         $"let q = new {NameThat}(localW.x, localW.y, localW.z, {OneValue} + dot).Normalized;"
                //     },
                ...
                //     Code = new[]
                //     {
                //         $"let c = {vec3Type.NameThat}.Cos(eulerAngle / 2);",
                //         $"let s = {vec3Type.NameThat}.Sin(eulerAngle / 2);",
                //     },
                //     Initializers = new[]
                //     {
            ...
            if (BaseType.HasArithmetics)
            {
                ...
                yield return new Operator(vec3Type, "*")
                {
                    ...
                    Code = new[]
                    {
                        $"let qv = {Construct(vec3Type, "q.x", "q.y", "q.z")};",
                        $"let uv = {vec3Type.Name}.Cross(qv, v);",
                        $"let uuv = {vec3Type.Name}.Cross(qv, uv);",
