...
namespace Atma.Math.Types
{
    class BuiltinType : AbstractType
    {
        ...
        public static IEnumerable<BuiltinType> GenericTypes
        {
            get
            {
                yield return TypeInt;
        ...
        public static readonly BuiltinType TypeFloat = new BuiltinType
        {
            ...
            TypeTestFuncs = new Dictionary<string, string>
            {
                { "IsInfinity", "{0}.IsInfinity" },
                { "IsFinite", "{0}.IsFinite" },
                { "IsNaN", "{0}.IsNaN" },
                { "IsNegativeInfinity", "{0}.IsNegativeInfinity" },
                { "IsPositiveInfinity", "{0}.IsPositiveInfinity" }
            }
        };
