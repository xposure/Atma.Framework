...
namespace Atma
{
    ...
    public class FontSize
    {
        ...
        /// </summary>
        public readonly Dictionary<char8, Character> Charset = new Dictionary<char8, Character>();

        public this(Font font, int size, StringView charset)
        {
            /*if (font.Disposed)
        ...
        /// </summary>
        public  bool Render(char unicode, Span<Color> buffer, out int width, out int height)
        {
            if (Charset.TryGetValue(unicode, out var ch) && ch.HasGlyph)
            {
