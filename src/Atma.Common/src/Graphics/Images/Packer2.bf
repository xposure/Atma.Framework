...
namespace Atma
{
	...
	public class Packer2
	{
		...
		public class Output
		{
			public readonly List<Image> Pages = new List<Image>() ~ DeleteContainerAndItems!(_);
			public readonly Dictionary<StringView, Entry> Entries = new Dictionary<StringView, Entry>() ~ DeleteDictionaryAndItems!(_);
		}
		...
		/// </summary>
		private Output _packed = new .() ~ delete _;
